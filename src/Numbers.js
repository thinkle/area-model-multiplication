var NUMBER_WORDS = [
  { matcher: /\b(one|a)\b/i, value: 1 },
  { matcher: /(two|\ba\s*(couple|pair)\b)/i, value: 2 },
  { matcher: /(\b(one|a)\b\s*)?half(\s+(a|an))?\b/i, value: 0.5 },
...
var NUMBER_FRACTIONS = [
  { numerator: 1, denominator: 2, word: "\u00BD" },
  { numerator: 1, denominator: 4, word: "\u00BC" },
  { numerator: 3, denominator: 4, word: "\u00BE" },
  { numerator: 1, denominator: 3, word: "\u2153" },
  { numerator: 2, denominator: 3, word: "\u2154" },
  { numerator: 1, denominator: 5, word: "\u2155" },
  { numerator: 2, denominator: 5, word: "\u2156" },
  { numerator: 3, denominator: 5, word: "\u2157" },
  { numerator: 4, denominator: 5, word: "\u2158" },
  { numerator: 1, denominator: 6, word: "\u2159" },
  { numerator: 5, denominator: 6, word: "\u215A" },
  { numerator: 1, denominator: 8, word: "\u215B" },
  { numerator: 3, denominator: 8, word: "\u215C" },
  { numerator: 5, denominator: 8, word: "\u215D" },
  { numerator: 7, denominator: 8, word: "\u215E" },
];
...
function floatToFrac(
  n,
  {
    denominators = [2, 3, 4, 5, 6, 8, 16],
    approx = 0.01,
    fallbackDigits = 2,
